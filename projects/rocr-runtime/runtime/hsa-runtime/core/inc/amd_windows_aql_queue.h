...
#ifndef HSA_RUNTIME_CORE_INC_AMD_WINDOWS_AQL_QUEUE_H_
#define HSA_RUNTIME_CORE_INC_AMD_WINDOWS_AQL_QUEUE_H_

#if !defined(_WIN32)
#error "amd_windows_aql_queue.h is Windows-only"
#endif
...
class WindowsAqlQueue : public core::Queue,
 ...
 public:
  ...
  WindowsAqlQueue(core::SharedQueue* shared_queue, WindowsGpuAgent* agent, size_t req_size_pkts,
              uint64_t flags, core::HsaEventCallback callback, void* err_data);
  ~WindowsAqlQueue() override;
 ...
 private:
  ...
  WindowsGpuAgent& agent_;
  WindowsLiteDriver& driver_;
  ...
  WindowsLiteDriver::DirectComputeQueue direct_queue_{};
...
#endif  // HSA_RUNTIME_CORE_INC_AMD_WINDOWS_AQL_QUEUE_H_
